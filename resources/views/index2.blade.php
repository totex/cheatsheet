...
<body class="bg-slate-950 text-slate-200">
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-72 bg-slate-900 border-r border-slate-800 overflow-y-auto">
            ...
            <nav class="px-2 space-y-2" x-data="{ openResources: false, openTables: false }" x-init="console.log('Alpine works')">

                <!-- Apache -->
                {{-- @click | @@click | x-on:click --}}
                <div>
                    <button x-on:click="openResources = !openResources"
                        class="flex justify-between w-full px-3 py-2 rounded hover:bg-slate-800">
                        <span>Apache</span>
                        <span x-text="openResources ? '−' : '+'"></span>
                    </button>
                    <div x-show="openResources" class="ml-4 mt-1 space-y-1">
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Service Management</a>
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Configurations</a>
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Virtual Hosts</a>
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Modules</a>
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Debug and Logs</a>
                    </div>
                </div>
                ...
                {{-- @click | @@click | x-on:click --}}
                <div>
                    <button x-on:click="openTables = !openTables"
                        class="flex justify-between w-full px-3 py-2 rounded hover:bg-slate-800">
                        <span>NGINX</span>
                        <span x-text="openTables ? '−' : '+'"></span>
                    </button>
                    <div x-show="openTables" class="ml-4 mt-1 space-y-1">
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Columns</a>
                        <a href="#" class="block px-2 py-1 rounded hover:bg-slate-800">Filters</a>
                    </div>
                </div>

                <!-- Forms -->
                {{-- <a href="#" class="block px-3 py-2 rounded hover:bg-slate-800">Forms</a>
                <a href="#" class="block px-3 py-2 rounded hover:bg-slate-800">Actions</a>
                <a href="#" class="block px-3 py-2 rounded hover:bg-slate-800">Widgets</a> --}}
